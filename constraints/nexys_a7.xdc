...
set_property -dict { PACKAGE_PIN E3    IOSTANDARD LVCMOS33 } [get_ports { master_clk }]; #IO_L12P_T1_MRCC_35 Sch=clk100mhz
create_clock -add -name clk_100 -period 10.00 -waveform {0 5} [get_ports {master_clk}];
create_generated_clock -name clk_25 -source [get_pins {_mmcm/_mmcm/CLKOUT0}] -divide_by 1 [get_pins {_mmcm/clk_out}]
...
set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS33 } [get_ports { trace_path }]; #IO_L3N_T0_DQS_EMCCLK_14 Sch=sw[1]
set_property -dict { PACKAGE_PIN M13   IOSTANDARD LVCMOS33 } [get_ports { clear_screen }]; #IO_L6N_T0_D08_VREF_14 Sch=sw[2]
...
set_property -dict { PACKAGE_PIN C17   IOSTANDARD LVCMOS33 } [get_ports { out_x }]; #IO_L20N_T3_A19_15 Sch=ja[1]
set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { dir_x }]; #IO_L21N_T3_DQS_A18_15 Sch=ja[2]
set_property -dict { PACKAGE_PIN E18   IOSTANDARD LVCMOS33 } [get_ports { n_en_x }]; #IO_L21P_T3_DQS_15 Sch=ja[3]
set_property -dict { PACKAGE_PIN G17   IOSTANDARD LVCMOS33 } [get_ports { out_servo }]; #IO_L18N_T2_A23_15 Sch=ja[4]
set_property -dict { PACKAGE_PIN D17   IOSTANDARD LVCMOS33 } [get_ports { out_y }]; #IO_L16N_T2_A27_15 Sch=ja[7]
set_property -dict { PACKAGE_PIN E17   IOSTANDARD LVCMOS33 } [get_ports { dir_y }]; #IO_L16P_T2_A28_15 Sch=ja[8]
set_property -dict { PACKAGE_PIN F18   IOSTANDARD LVCMOS33 } [get_ports { n_en_y }]; #IO_L22N_T3_A16_15 Sch=ja[9]
